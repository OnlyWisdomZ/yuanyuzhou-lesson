...
@Schema(name = "预支付DTO")
@Data
public class PrePayDTO implements Serializable, RE {
	...
	@Schema(description = "订单实际支付总金额")
	@NotNull(message = "订单实际支付总金额不能为空")
	@DecimalMin(value = "0", message = "订单实际支付总金额不能小于0元")
