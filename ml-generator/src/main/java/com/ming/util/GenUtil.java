...
public class GenUtil {
    /** MySQL主机地址 */
    private static final String MYSQL_HOST = "192.168.179.135:3306";
    /** 数据库账号 */
    private static final String MYSQL_USERNAME = "root";
    /** 数据库密码 */
    private static final String MYSQL_PASSWORD = "root";
    /** 作者 */
    private static final String AUTHOR = "Ming";
    /** 根包 */
    private static final String BASE_PACKAGE = "com.ming";
    ...
    public static Generator getGenerator(String dbName, String moduleName, Set<String> tableNames) {
        ...
        globalConfig.enableServiceImpl().setCacheExample(true).setOverwriteEnable(true);
